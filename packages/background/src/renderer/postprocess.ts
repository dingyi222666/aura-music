...
void main() {
  ...
  // Leave the upper color field open, with a quiet lower area behind controls.
  // Exposure is independent of the cover's chroma and of the beat envelope.
...
export class Blur {
  ...
  resize(width: number, height: number, limit = 768) {
    const gl = this.gl;
